...
exports.run = (client, msg, args) => {
  ...
  if(!contents) {
    [title, contents] = ["Basarim kazandiniz", title];
  }
  ...
  if(title.length > 22 || contents.length > 22) return msg.edit("<a:Basarisizz:601081455455502366> En fazla 22 harf kullanabilirsin.").then(msg.delete.bind(msg), 2000);
